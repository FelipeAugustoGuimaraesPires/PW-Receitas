...
function validarCampos() {
    ...
    const nomeReceita = document.querySelector('#nome_receita');
    ...
    if (nomeReceita.value.trim() === '') {
        nomeReceita.classList.add('error');
        nomeReceita.nextElementSibling.textContent = 'Preencha este campo.';
        isFormValid = false;
    } else {
        nomeReceita.classList.remove('error');
        nomeReceita.nextElementSibling.textContent = '';
    }

    if (receita.value.trim() === '') {
        receita.classList.add('error');
        receita.nextElementSibling.textContent = 'Preencha este campo.';
        isFormValid = false;
    } else {
        receita.classList.remove('error');
        receita.nextElementSibling.textContent = '';
    }
...
function enviarFormulario() {
    if (validarCampos()) {
        ...
        adicionarReceita(nomeReceita.value, receita.value, imagem.value);
