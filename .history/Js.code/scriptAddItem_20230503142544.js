...
editarButton.onclick = function () {
    ...
    nomeInput.value = receitas[i].nome;

    const imagemInput = document.querySelector('#imagem');
    imagemInput.value = receitas[i].imagem;

    const descricaoInput = document.querySelector('#descricao');
    descricaoInput.value = receitas[i].descricao;

    const ingredientesInput = document.querySelector('#ingredientes');
    ingredientesInput.value = receitas[i].ingredientes.join(', ');

    const preparoInput = document.querySelector('#preparo');
    preparoInput.value = receitas[i].preparo;
