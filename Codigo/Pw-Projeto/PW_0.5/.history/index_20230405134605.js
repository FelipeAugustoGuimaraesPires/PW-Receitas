...
class NavigationHeader2 {
    constructor() {
      this.navigation_header2  = document.querySelector('.menu-item');
      window.addEventListener('resize', () => {
        if (window.innerWidth < 768) {
          this.navigation_header2 .classList.add('menu-item-hidden');
        } else {
          this.navigation_header2 .classList.remove('menu-item-hidden');
        }
      });
    }
  }
